...
cp out/arch/arm64/boot/{dtbo.img,Image.lz4} "$ROOT_DIR/device/google/redfin-kernel"
cp out/arch/arm64/boot/dts/google/qcom-base/lito.dtb "$ROOT_DIR/device/google/redfin-kernel"
